...
insert into thebook_platform.user(id, nome, username, email, senha, data_nasc, cpf,
    data_entr, situacao, papel) values ('1b185f9e-6c0f-4617-bd77-dd4620a41a0f'::uuid,
        'Nicole', 'nicole', 'nickel@yahho.com',
        '$2a$10$6ntpsnNIXuFuPkIU08EiueXZh2qu4cUZQ0McdaujdfZUgWjZ0JPGq', --! password !--
        '2006-06-02 08:00:00', '12345678901', '2020-06-02 08:00:00', 'LIVRE', 'ADMIN');

insert into thebook_platform.user(id, nome, username, email, senha, data_nasc, cpf,
    data_entr, situacao, papel) values ('cc171e74-5dc3-4a38-9c86-5844ed673b5f'::uuid,
    'Kauã', 'kaua', 'kaua@yahoo.com',
    '$2a$10$LzzhmD5vaUQEe2nXvarWsOqpzxkrON9u20dooYrMTesQLk4zzBV5S', --! senha !--
    '2006-01-01 09:00:00', '12345678902', '2020-01-01 09:00:00', 'LIVRE', 'LEITOR');

--! Book Queries !--

insert into thebook_platform.livro(id, paginas, titulo, genero, autor, classificacao, resumo,
    data_add, id_user_add, status, media_aval) values ('582c710f-849c-4a9f-a10f-0b68c784f240'::uuid,
...
insert into thebook_platform.livro(id, paginas, titulo, genero, autor, classificacao, resumo,
    data_add, id_user_add, status, media_aval) values ('a0b0c0d0-e0f0-1a2b-3c4d-5e6f7a8b9c0d'::uuid,
...
insert into thebook_platform.leitura(id, id_user, id_livro, data_inicio, status, favoritado, avaliacao)
...
insert into thebook_platform.comment(id, id_user, id_livro, texto)
values ('1b185f9e-6c0f-4617-bd77-dd4620a41a0f'::uuid, 'cc171e74-5dc3-4a38-9c86-5844ed673b5f'::uuid,
